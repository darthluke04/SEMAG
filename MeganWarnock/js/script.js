...
/*gameStartSong.addEventListener('ended', function startSong(,false{
	this.play();
}*/
function song(){
if (typeof gameStartSong.loop == 'boolean')
{
    gameStartSong.loop = true;
}
else
{
  gameStartSong.addEventListener('ended', function startSong() {
    this.currentTime = 0;
    this.play();
